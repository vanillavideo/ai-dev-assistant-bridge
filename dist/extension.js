"use strict";var X=Object.create;var E=Object.defineProperty;var Q=Object.getOwnPropertyDescriptor;var Z=Object.getOwnPropertyNames;var ee=Object.getPrototypeOf,te=Object.prototype.hasOwnProperty;var oe=(e,t)=>{for(var o in t)E(e,o,{get:t[o],enumerable:!0})},M=(e,t,o,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let d of Z(t))!te.call(e,d)&&d!==o&&E(e,d,{get:()=>t[d],enumerable:!(r=Q(t,d))||r.enumerable});return e};var O=(e,t,o)=>(o=e!=null?X(ee(e)):{},M(t||!e||!e.__esModule?E(o,"default",{value:e,enumerable:!0}):o,e)),ne=e=>M(E({},"__esModule",{value:!0}),e);var ke={};oe(ke,{activate:()=>de,deactivate:()=>we});module.exports=ne(ke);var n=O(require("vscode")),T=O(require("http")),H=O(require("fs")),U=O(require("path")),C,p,$,y,x,I,L,S,v=3737,b,N;function a(e,t,o){let d=`[${new Date().toISOString()}] [${e}]`,s=o?`${d} ${t} ${JSON.stringify(o)}`:`${d} ${t}`;p.appendLine(s),e==="ERROR"&&console.error(s)}function m(){return n.workspace.getConfiguration("aiFeedbackBridge",null)}async function P(e,t){await m().update(e,t,n.ConfigurationTarget.Global)}var J="aiFeedbackBridge.portRegistry",D=3737,ae=50;async function V(e){return e.globalState.get(J,[])}async function B(e,t){await e.globalState.update(J,t)}async function re(e){let t=await V(e),o=n.workspace.name||"No Workspace",r=n.workspace.workspaceFolders?.[0]?.uri.fsPath||"no-workspace",d=Date.now()-60*60*1e3,s=t.filter(g=>g.timestamp>d),i=s.find(g=>g.workspace===r);if(i)return a("INFO",`Reusing existing port ${i.port} for workspace`),i.timestamp=Date.now(),await B(e,s),i.port;let c=new Set(s.map(g=>g.port)),l=D;for(let g=0;g<ae;g++){let h=D+g;if(!c.has(h)&&await se(h)){l=h;break}}return s.push({port:l,workspace:r,timestamp:Date.now()}),await B(e,s),a("INFO",`Auto-assigned port ${l} for workspace: ${o}`),l}async function se(e){return new Promise(t=>{let o=T.createServer();o.once("error",r=>{r.code==="EADDRINUSE"?t(!1):t(!0)}),o.once("listening",()=>{o.close(),t(!0)}),o.listen(e)})}async function ie(e,t){let o=await V(e),r=n.workspace.workspaceFolders?.[0]?.uri.fsPath||"no-workspace",d=o.filter(s=>!(s.port===t&&s.workspace===r));await B(e,d),a("INFO",`Released port ${t}`)}function ce(e){let t=n.window.createWebviewPanel("aiFeedbackBridgeSettings","AI Feedback Bridge Settings",n.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0}),o=m();t.webview.html=W(o,v),t.webview.onDidReceiveMessage(async r=>{switch(r.command){case"updateSetting":await P(r.key,r.value),a("INFO",`Setting updated: ${r.key} = ${r.value}`);break;case"reload":t.webview.html=W(m(),v);break;case"injectScript":j();break}},void 0,e.subscriptions)}function W(e,t){let o=[{key:"tasks",icon:"\u{1F4CB}",name:"Tasks",interval:300},{key:"improvements",icon:"\u2728",name:"Improvements",interval:600},{key:"coverage",icon:"\u{1F9EA}",name:"Coverage",interval:900},{key:"robustness",icon:"\u{1F6E1}\uFE0F",name:"Robustness",interval:600},{key:"cleanup",icon:"\u{1F9F9}",name:"Cleanup",interval:1200},{key:"commits",icon:"\u{1F4BE}",name:"Commits",interval:900}],r=e.get("autoContinue.enabled",!1),d=e.get("autoApproval.enabled",!1),s=e.get("autoApproval.autoInject",!1),i="";for(let c of o){let l=e.get(`autoContinue.${c.key}.enabled`,!0),g=e.get(`autoContinue.${c.key}.interval`,c.interval);i+=`
			<tr class="${l?"":"disabled"}">
...
Click to start`)}async function K(e){let t=m(),o=["tasks","improvements","coverage","robustness","cleanup","commits"],r=Date.now(),d=[],s="autoContinue.lastSent",i=e.globalState.get(s,{}),c={...i};for(let l of o){let g=t.get(`autoContinue.${l}.enabled`,!0),h=t.get(`autoContinue.${l}.interval`,300),A=t.get(`autoContinue.${l}.message`,"");if(!g||!A)continue;let w=i[l]||0;(r-w)/1e3>=h&&(d.push(A),c[l]=r)}return await e.globalState.update(s,c),d.length===0?"":d.join(". ")+"."}function _(e){if(m().get("autoContinue.enabled",!1)){let d=n.workspace.name||"No Workspace";a("INFO",`\u2705 Auto-Continue enabled for window: ${d}`),S=setInterval(async()=>{try{let s=await K(e);s&&(a("INFO","[Auto-Continue] Sending periodic reminder"),await F(s,{source:"auto_continue",timestamp:new Date().toISOString()}))}catch(s){a("ERROR","[Auto-Continue] Failed to send message",{error:s})}},500)}else a("DEBUG","Auto-Continue is disabled")}function le(e){S&&(clearInterval(S),S=void 0,p.appendLine("Auto-Continue stopped")),_(e)}async function pe(e,t,o,r){p.appendLine(`Chat request received: ${e.prompt}`),o.markdown(`### \u{1F504} Processing Feedback
...
`);try{let[s]=await n.lm.selectChatModels({vendor:"copilot",family:"gpt-4o"});if(s){let i=[n.LanguageModelChatMessage.User(e.prompt)],c=await s.sendRequest(i,{},r);for await(let l of c.text)o.markdown(l)}}catch(s){s instanceof n.LanguageModelError&&(p.appendLine(`Language model error: ${s.message}`),o.markdown(`\u26A0\uFE0F Error: ${s.message}
