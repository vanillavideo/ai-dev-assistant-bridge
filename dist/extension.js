"use strict";var X=Object.create;var E=Object.defineProperty;var Q=Object.getOwnPropertyDescriptor;var Z=Object.getOwnPropertyNames;var ee=Object.getPrototypeOf,te=Object.prototype.hasOwnProperty;var oe=(e,o)=>{for(var t in o)E(e,t,{get:o[t],enumerable:!0})},D=(e,o,t,r)=>{if(o&&typeof o=="object"||typeof o=="function")for(let d of Z(o))!te.call(e,d)&&d!==t&&E(e,d,{get:()=>o[d],enumerable:!(r=Q(o,d))||r.enumerable});return e};var O=(e,o,t)=>(t=e!=null?X(ee(e)):{},D(o||!e||!e.__esModule?E(t,"default",{value:e,enumerable:!0}):t,e)),ne=e=>D(E({},"__esModule",{value:!0}),e);var ke={};oe(ke,{activate:()=>de,deactivate:()=>we});module.exports=ne(ke);var n=O(require("vscode")),j=O(require("http")),U=O(require("fs")),J=O(require("path")),C,u,P,y,A,L,R,x,v=3737,b,N;function a(e,o,t){let d=`[${new Date().toISOString()}] [${e}]`,s=t?`${d} ${o} ${JSON.stringify(t)}`:`${d} ${o}`;u.appendLine(s),e==="ERROR"&&console.error(s)}function m(){return n.workspace.getConfiguration("aiFeedbackBridge",null)}async function B(e,o){await m().update(e,o,n.ConfigurationTarget.Global)}var V="aiFeedbackBridge.portRegistry",W=3737,ae=50;async function K(e){return e.globalState.get(V,[])}async function T(e,o){await e.globalState.update(V,o)}async function re(e){let o=await K(e),t=n.workspace.name||"No Workspace",r=n.workspace.workspaceFolders?.[0]?.uri.fsPath||"no-workspace",d=Date.now()-60*60*1e3,s=o.filter(p=>p.timestamp>d),i=s.find(p=>p.workspace===r);if(i)return a("INFO",`Reusing existing port ${i.port} for workspace`),i.timestamp=Date.now(),await T(e,s),i.port;let c=new Set(s.map(p=>p.port)),l=W;for(let p=0;p<ae;p++){let w=W+p;if(!c.has(w)&&await se(w)){l=w;break}}return s.push({port:l,workspace:r,timestamp:Date.now()}),await T(e,s),a("INFO",`Auto-assigned port ${l} for workspace: ${t}`),l}async function se(e){return new Promise(o=>{let t=j.createServer();t.once("error",r=>{r.code==="EADDRINUSE"?o(!1):o(!0)}),t.once("listening",()=>{t.close(),o(!0)}),t.listen(e)})}async function ie(e,o){let t=await K(e),r=n.workspace.workspaceFolders?.[0]?.uri.fsPath||"no-workspace",d=t.filter(s=>!(s.port===o&&s.workspace===r));await T(e,d),a("INFO",`Released port ${o}`)}function ce(e){let o=n.window.createWebviewPanel("aiFeedbackBridgeSettings","AI Feedback Bridge Settings",n.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0}),t=m();o.webview.html=z(t,v),o.webview.onDidReceiveMessage(async r=>{switch(r.command){case"updateSetting":await B(r.key,r.value),a("INFO",`Setting updated: ${r.key} = ${r.value}`);break;case"reload":o.webview.html=z(m(),v);break;case"injectScript":M();break}},void 0,e.subscriptions)}function z(e,o){let t=[{key:"tasks",icon:"\u{1F4CB}",name:"Tasks",interval:300},{key:"improvements",icon:"\u2728",name:"Improvements",interval:600},{key:"coverage",icon:"\u{1F9EA}",name:"Coverage",interval:900},{key:"robustness",icon:"\u{1F6E1}\uFE0F",name:"Robustness",interval:600},{key:"cleanup",icon:"\u{1F9F9}",name:"Cleanup",interval:1200},{key:"commits",icon:"\u{1F4BE}",name:"Commits",interval:900}],r=e.get("autoContinue.enabled",!1),d=e.get("autoApproval.enabled",!1),s=e.get("autoApproval.autoInject",!1),i="";for(let c of t){let l=e.get(`autoContinue.${c.key}.enabled`,!0),p=e.get(`autoContinue.${c.key}.interval`,c.interval);i+=`
			<tr class="${l?"":"disabled"}">
...
</html>`}async function we(){C&&(C.close(),a("INFO","HTTP server closed")),x&&(clearInterval(x),x=void 0,a("INFO","Auto-continue timer cleared")),b&&(clearInterval(b),b=void 0,a("INFO","Auto-approval interval cleared")),N&&await ie(N,v),a("INFO","\u{1F44B} AI Agent Feedback Bridge deactivated")}0&&(module.exports={activate,deactivate});
